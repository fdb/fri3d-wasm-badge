...
// Initialize wasm3, load the embedded .wasm, link all host functions,
// and resolve the render/on_input exports.
// Returns nullptr on success, otherwise a static error description.
const char* init(fri3d::Canvas& canvas, fri3d::Random& random);
